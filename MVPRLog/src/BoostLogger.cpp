...
void BoostLogger::WriteLog(const char *filename, const char *func, int line, logging::trivial::severity_level level, const char *fmt, ...) {
    va_list al;
    va_start(al, fmt);
...
void BoostLogger::WriteLog(const logging::trivial::severity_level &level, const char* message) {
    src::severity_logger_mt<logging::trivial::severity_level> &lg = globalLogger::get();
...
int BoostLogger::backendInit(const AbstractLogConfig &logConfig) {
    ...
    if (logConfig.m_isSynchronize) {
        ...
        if (logConfig.m_logLevel == "trace") {
            text_sink->set_filter(expr::attr< logging::trivial::severity_level >("Severity") >= logging::trivial::severity_level::trace);
        } else if (logConfig.m_logLevel == "debug"){
            text_sink->set_filter(expr::attr< logging::trivial::severity_level >("Severity") >= logging::trivial::severity_level::debug);
        } else if (logConfig.m_logLevel == "info"){
            text_sink->set_filter(expr::attr< logging::trivial::severity_level >("Severity") >= logging::trivial::severity_level::info);
        } else if (logConfig.m_logLevel == "warning"){
            text_sink->set_filter(expr::attr< logging::trivial::severity_level >("Severity") >= logging::trivial::severity_level::warning);
        } else if (logConfig.m_logLevel == "error"){
            text_sink->set_filter(expr::attr< logging::trivial::severity_level >("Severity") >= logging::trivial::severity_level::error);
        }else if (logConfig.m_logLevel == "fatal"){
            text_sink->set_filter(expr::attr< logging::trivial::severity_level >("Severity") >= logging::trivial::severity_level::fatal);
        }
